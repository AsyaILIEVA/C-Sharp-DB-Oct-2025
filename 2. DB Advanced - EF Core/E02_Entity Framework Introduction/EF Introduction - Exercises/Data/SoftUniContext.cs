...
//namespace E01_EntityFramework_Introduction.Data;
...
//        {
//            optionsBuilder.
//                UseSqlServer("Server=.;Database=SoftUni;Integrated Security=True;Encrypt=False;");
//        }
//    }
    ...
    public partial class SoftUniContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                optionsBuilder
                    .UseSqlServer(
                        "Server =.; Database = SoftUni; Integrated Security = True; Encrypt = False;");
            }
        }
