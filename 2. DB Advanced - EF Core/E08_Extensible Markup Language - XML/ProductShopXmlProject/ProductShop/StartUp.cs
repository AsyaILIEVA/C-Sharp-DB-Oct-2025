namespace ProductShop
{
    ...
    public class StartUp
    {
        ...
        private static void ResetAndSeedDatabase(ProductShopContext dbContext)
        {
            ...
            //string xmlFileText = ReadXmlDatasetFileContents("products.xml");
            //string result = ImportProducts(dbContext, xmlFileText);

            //string xmlFileText = ReadXmlDatasetFileContents("categories.xml");
            //string result = ImportCategories(dbContext, xmlFileText);

            //string xmlFileText = ReadXmlDatasetFileContents("categories-products.xml");
